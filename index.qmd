...
1. Make a local directory for the project `cardstocode`. From the command line: 
...
3. Create a Python file `c2c.py`. From the command line: 

```bash
touch c2c.py
```

4. Deactivating and reactivating the virtual environment: 
...
### Step 2: Import and install packages
...
### Step 1: Imports
Let's start by importing `numpy` and `random`. 
