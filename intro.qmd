...
What's the best that we could do against Rock only? We could play **purely paper**. This is called a **best response** strategy. Any deterministic strategy can be fully exploited. The payoffs are written for playing Paper and the probabilities indicate the opponent playing only Rock. 
