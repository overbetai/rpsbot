...
format:
  html:
    math: true
---
Add a "Getting Started" template that new players can use
Include example submission format
Add more details about scoring and rankings
Consider adding a "Common Pitfalls" section
