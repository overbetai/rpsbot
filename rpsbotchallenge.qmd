...
The bots will get roughly more difficult as the week goes on from Monday to Sunday. They'll be all different types -- LLM-generated, our own house bots, human-made bots from our weekly challenges, etc. 
...
After each round, you can see the entire play history against each bot and a matrix score report. Once a house bot enters, it stays in for subsequent rounds. 
